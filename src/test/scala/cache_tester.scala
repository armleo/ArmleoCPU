...
class CacheSpec extends AnyFreeSpec with ChiselScalatestTester {
  ...
  "Basic Cache functionality test" in {
    test(new Cache(cp = c.icache)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
      ...
      dut.s0.writepayload.paddr.poke(BigInt(/*cptag*/"0001" + /*entry num*/"0000" + /*bus_num*/"0" + "00", 2))
      dut.s0.writepayload.way_idx_in.poke(0)
      dut.s0.writepayload.bus_aligned_data(0).poke(BigInt("8F", 16))
      dut.s0.writepayload.bus_mask(0).poke(false)
      dut.s0.writepayload.bus_aligned_data(1).poke(BigInt("CF", 16))
      dut.s0.writepayload.bus_mask(1).poke(true)
      dut.s0.writepayload.valid.poke(true)
      dut.clock.step(1)
      ...
      dut.s0.writepayload.data.meta.perm.dirty.poke(false)
      dut.s0.writepayload.data.meta.perm.access.poke(false)
      dut.s0.writepayload.data.meta.perm.global.poke(false)
      dut.s0.writepayload.data.meta.perm.user.poke(false)
      dut.s0.writepayload.data.meta.perm.execute.poke(false)
      dut.s0.writepayload.data.meta.perm.write.poke(false)
      dut.s0.writepayload.data.meta.perm.read.poke(true)
      dut.s0.writepayload.data.meta.valid.poke(true)
      dut.s0.writepayload.data.ptag.poke(100)*/
      //dut.clock.step(1)
      /*
      /**************************************************************************/
      ...
      dut.s0.writepayload.data.meta.perm.dirty.poke(true)
      dut.s0.writepayload.data.meta.perm.access.poke(false)
      dut.s0.writepayload.data.meta.perm.global.poke(false)
      dut.s0.writepayload.data.meta.perm.user.poke(false)
      dut.s0.writepayload.data.meta.perm.execute.poke(false)
      ...
      dut.s0.writepayload.data.meta.perm.read.poke(true)
      dut.s0.writepayload.data.meta.valid.poke(true)
      dut.s0.writepayload.data.ptag.poke(104)
      dut.clock.step(1)
      ...
      dut.s0.writepayload.data.meta.perm.read.poke(true)
      dut.s0.writepayload.data.meta.valid.poke(true)
      dut.s0.writepayload.data.ptag.poke(108)
      dut.clock.step(1)
